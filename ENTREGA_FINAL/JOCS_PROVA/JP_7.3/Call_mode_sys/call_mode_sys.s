...
.text
       ...
       $MOVEI r6, bucle   ;adreça de la rutina principal
       jmp    r6
...
RSG:   movi r7, 0x00
       ...
       ; *=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
bucle: movi R0,0
       calls r0          ;llamamos a calls para forzar la excepcion de instruccion ilegal ya que estamos en modo sistema intenando lanzar una call 0(0x0)
       bz r0,bucle 
       halt
