...
RSG:   movi r7, 0x00
       ...
       ; Rutina principal
       ; *=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
inici: flush r2           ;usamos una instruccion no implementada en la etapa7.2 por tanto illegal en el momento y forzamos la excepcion de instruccion illegal 0(0x0)
       movi R0,0
       bz   r0,inici
       halt
